            ...
            <div className="post-content-container">
                <div className="post-content">
                    <div className="post-header">
                        <h1>{data.author.name} {data.author.profile.surname}
                    ...
                    <p className="post-content-value"><ReceiptIcon />
                        <span>
                            {(parseInt(data.initial_balance) + parseInt(data.deserved_count) - parseInt(data.undeserved_count))}
                        </span>
                    </p>
                </div>
                <div className="post-btn-group">
                    <div className="post-btn">
                        <span className="btn-icon"><ThumbUpAltIcon className="btn-icon-icon"/> <span>{data.deserved_count}</span></span>
                    </div>
                    <div className="post-btn">
